namespace RetoPrincipiosSolid
{
    ...
    class Program
    {
        ...
        /* Aqui se aplica el 1 principio por esta razon: interfaz IReserva 
         * tiene la responsabilidad unica en los metodos crear y cancelar la reserva
         */
        ...
        /* aqui se aplica el 2 Principio de Abierto/Cerrado; ya que el metodo procesar esta abiertas para 
         * la extension de invocar el metodo procesar :en las clases TarjetaCredito , Paypal y Transferencia
         * pero cerradas para modificacion en la clase MetodoPago
         */
        ...
        /* aqui se aplica el 2 Principio de Abierto/Cerrado; ya que el metodo procesar esta abiertas para 
     * la extension de invocar el metodo procesar :en las clases EmailNotificacion y SmsNotificacion  
     * pero cerradas para modificacion en la interfaz INotificacion
     */
        ...
        /*
        Aqui se aplica el 4.  Principio de Segregación de Interfaces, 
        ya que solo se esta haciendo uso y dependen de los metodos que se encuentra en la interfaz IReserva 
        */
        ...
        /* Aqui se aplica el 5 Principio de Inversión de Dependencias, ya que se hace uso de la abstraciones
         * que vienen a ser 
         */
        public class SistemaReservacion : IReserva, IPago
        {
            ...
            /* aqui se aplica el 3 principio  de Sustitución de Liskov
             * ya que  implementacion del metodo RegistrarEvento va a funcionar aqui
             */
